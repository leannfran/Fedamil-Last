            ...
            <div className="p-7 col-span-1">
                ...
                <div className="leading-8">
                    ...
                    <div className="flex items-center space-x-4 pt-7">
                        ...
                        <h3 className='text-1xl font-bold'>PRESUPUESTOS ONLINE</h3>
                    </div>
                    ...
                    <div className="flex items-center space-x-4 pt-7">
                        ...
                        <h3 className='text-1xl font-bold'>TODOS LOS MÉTODOS DE PAGO</h3>
                    </div>
                    ...
                    <div className="flex items-center space-x-4 pt-7">
                        ...
                        <h3 className='text-1xl font-bold'>ENTREGAS</h3>
                    </div>
                    <p className='ms-14'>Contamos con servicio de entrega en obra con flota propia, servicio de hidrogrúa propio y óptimo cumplimiento de envios en tiempo y forma.</p>
                </div>
            </div>
