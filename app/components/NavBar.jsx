...
export default function NavBar() {
  ...
  <div className="flex items-center space-x-4">
    ...
    <a href="https://www.instagram.com/fedamil/" target="_blank" rel="noopener noreferrer" className="text-amarillo hover:text-amarillo text-xl">
      <AiFillInstagram />
    </a>
    <a href="https://www.tiktok.com/@tu_usuario" target="_blank" rel="noopener noreferrer" className="text-amarillo hover:text-amarillo text-xl">
      ...
      >
       <Link
        ...
        <div className="mt-4">
          <button className="flex items-center border border-white justify-center text-white">
            <GrContact className="w-8 h-8 p-1 bg-amarillo" />
            <span className="bg-azul text-xs p-2">
              SOLICITAR PRESUPUESTO
            </span>
          </button>
        </div>
